...
menu:
	...
	echo "4 make test_unit        - run unit tests (provider tests)"
...
test_unit:
	flutter test test/counter_provider_test.dart test/theme_provider_test.dart test/user_provider_test.dart test/async_loading_mixin_test.dart

test_widget:
	flutter test test/count_text_test.dart test/settings_screen_test.dart test/routing_test.dart test/async_builder_test.dart
